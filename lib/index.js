...
var Breakdancer = function () {
  ...
  _createClass(Breakdancer, [{
    ...
    value: function width() {
      return this.window.innerWidth || this.window.document.documentElement.clientWidth || this.window.document.body.clientWidth;
    }
    ...
    value: function height() {
      return this.window.innerHeight || this.window.document.documentElement.clientHeight || this.window.document.body.clientHeight;
    }
